          ...
          <div className="detail__grid">
            ...
            <div className="gallery">
              <div className="gallery__main">
                {photo === 0 ? (
                  <img src={window.__resources.cascadia} alt={`${u.brand} ${u.model}`} />
                ) : (
                ...
                <button className="gallery__nav gallery__nav--prev" onClick={prev} aria-label="Anterior">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="15 18 9 12 15 6"/></svg>
                </button>
                <button className="gallery__nav gallery__nav--next" onClick={next} aria-label="Siguiente">
              ...
              <div className="gallery__thumbs">
                {[...Array(totalPhotos)].map((_, i) => (
                  <button key={i} className={`gallery__thumb ${photo === i ? 'is-active' : ''}`} onClick={() => setPhoto(i)}>
                    ...
                    {i === 0 && <img src={window.__resources.cascadia} alt="" />}
                  </button>
                ))}
              </div>
            </div>
